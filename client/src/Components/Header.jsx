      ...
      <div className='grid grid-cols-12   h-full pt-2 pb-2 pl-3 pr-3 bg-transparent '>
            ...
            <div id='cont2' className='place-items-center  flex justify-center w-full  h-full  md:pb-0 sm:pb-0 lg:pb-0 space-x-2'>
              <div className=' rounded-full  w-1/2 h-full border-slate-400  border-double border  sm:mt-0  flex items-center justify-center self-center lg:h-full bg-white  '>
                <div className='w-5/6'>
                  <input id='search'
                    type="text"
                    className='   rounded-full text-center    w-full h-fit '
                    placeholder="Search"
                  />
                </div>
                <button
        ...
        <div id='cont3' className='col-span-2   flex h-max w-full justify-end '>
          <div className='absolute  flex   space-x-3  lg:mt-0 '>
            <button color='gray ' className=' mb-1 lg:mb-0  ' >
              <FaMoon color='gray' className='size-6  ' />
            </button>
            ...
            <button type="button" class=" hidden lg:block md:block sm:block text-sm text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded  h-8 text-center ">
              <Link to='/sign-in' className='m-2 '>Sign In </Link>
            </button>
          </div>
